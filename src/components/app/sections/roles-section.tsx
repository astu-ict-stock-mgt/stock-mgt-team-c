...
const ALL_PERMISSIONS_BY_MODULE: Record<string, string[]> = {
  ...
  "Stock Taking": ["stocktakes.create", "stocktakes.read", "stocktakes.update", "stocktakes.submit", "stocktakes.review", "stocktakes.recount"],
  "Stock Adjustments": ["stockadjustments.read", "stockadjustments.approve", "stockadjustments.post"],
