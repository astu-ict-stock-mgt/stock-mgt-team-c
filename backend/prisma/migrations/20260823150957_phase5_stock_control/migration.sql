...
-- CreateEnum
CREATE TYPE "SIVStatus" AS ENUM ('DRAFT', 'PRELIMINARY', 'UNDER_APPROVAL', 'AMENDMENT_REQUIRED', 'APPROVED', 'REJECTED', 'CANCELLED', 'FINALIZED', 'ISSUED');

-- CreateEnum
CREATE TYPE "VoucherType" AS ENUM ('SIV', 'ISIV');

-- CreateEnum
CREATE TYPE "ReturnStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'UNDER_EVALUATION', 'APPROVED', 'REJECTED', 'RECEIVED');

-- CreateEnum
CREATE TYPE "TransferStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'APPROVED', 'REJECTED', 'DISPATCHED', 'RECEIVED', 'COMPLETED');

-- CreateEnum
CREATE TYPE "BinTransferStatus" AS ENUM ('DRAFT', 'EXECUTED');
...
CREATE TABLE "StoreIssueVoucher" (
    ...
    "voucherType" "VoucherType" NOT NULL DEFAULT 'SIV',
...
-- CreateTable
CREATE TABLE "ReturnBinAllocation" (
    "id" TEXT NOT NULL,
    "returnItemId" TEXT NOT NULL,
    "binId" TEXT NOT NULL,
    "quantity" DOUBLE PRECISION NOT NULL,

    CONSTRAINT "ReturnBinAllocation_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "TransferOutBinAllocation" (
    "id" TEXT NOT NULL,
    "transferItemId" TEXT NOT NULL,
    "binId" TEXT NOT NULL,
    "quantity" DOUBLE PRECISION NOT NULL,

    CONSTRAINT "TransferOutBinAllocation_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "TransferInBinAllocation" (
    "id" TEXT NOT NULL,
    "transferItemId" TEXT NOT NULL,
    "binId" TEXT NOT NULL,
    "quantity" DOUBLE PRECISION NOT NULL,

    CONSTRAINT "TransferInBinAllocation_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "BinTransfer" (
    "id" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    "storeId" TEXT NOT NULL,
    "itemId" TEXT NOT NULL,
    ...
    "quantity" DOUBLE PRECISION NOT NULL,
    "requestedById" TEXT NOT NULL,
    "status" "BinTransferStatus" NOT NULL DEFAULT 'DRAFT',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "BinTransfer_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "BinTransfer_code_key" ON "BinTransfer"("code");
...
-- AddForeignKey
ALTER TABLE "StoreReturnNote" ADD CONSTRAINT "StoreReturnNote_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "Store"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "StoreReturnNote" ADD CONSTRAINT "StoreReturnNote_returnedById_fkey" FOREIGN KEY ("returnedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ReturnBinAllocation" ADD CONSTRAINT "ReturnBinAllocation_returnItemId_fkey" FOREIGN KEY ("returnItemId") REFERENCES "StoreReturnItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReturnBinAllocation" ADD CONSTRAINT "ReturnBinAllocation_binId_fkey" FOREIGN KEY ("binId") REFERENCES "Bin"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TransferOutBinAllocation" ADD CONSTRAINT "TransferOutBinAllocation_transferItemId_fkey" FOREIGN KEY ("transferItemId") REFERENCES "TransferRequestItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TransferOutBinAllocation" ADD CONSTRAINT "TransferOutBinAllocation_binId_fkey" FOREIGN KEY ("binId") REFERENCES "Bin"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TransferInBinAllocation" ADD CONSTRAINT "TransferInBinAllocation_transferItemId_fkey" FOREIGN KEY ("transferItemId") REFERENCES "TransferRequestItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TransferInBinAllocation" ADD CONSTRAINT "TransferInBinAllocation_binId_fkey" FOREIGN KEY ("binId") REFERENCES "Bin"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BinTransfer" ADD CONSTRAINT "BinTransfer_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "Store"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BinTransfer" ADD CONSTRAINT "BinTransfer_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "InventoryItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BinTransfer" ADD CONSTRAINT "BinTransfer_fromBinId_fkey" FOREIGN KEY ("fromBinId") REFERENCES "Bin"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BinTransfer" ADD CONSTRAINT "BinTransfer_toBinId_fkey" FOREIGN KEY ("toBinId") REFERENCES "Bin"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BinTransfer" ADD CONSTRAINT "BinTransfer_requestedById_fkey" FOREIGN KEY ("requestedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
